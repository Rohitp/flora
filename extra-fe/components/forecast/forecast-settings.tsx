  ...
  return (
    <div className="flex items-center justify-between py-1.5">
      <div className="flex items-center gap-1.5">
        <Label className="text-xs text-card-foreground cursor-pointer">{label}</Label>
        {tooltip && (
...
export function ForecastSettings({
  ...
  return (
    <div className="rounded-lg border border-border bg-card">
      ...
      {/* Warning when proration is off */}
      {!settings.proration && (
        <div className="border-t border-border bg-chart-4/5 px-4 py-2">
